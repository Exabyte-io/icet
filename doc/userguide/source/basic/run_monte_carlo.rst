...
the results are written to file (in the form of a :ref:`DataContainer
...
whereas the Monte Carlo simulation takes about 1-2 milliseconds per MC trial
step, but note that for a production simulation, the supercell should be
larger and the sampling both longer and more dense.

The VCSGC ensemble
------------------

A simulation in the VCSGC ensemble is almost identic.

.. literalinclude:: ../../../../tutorial/basic/5b_run_monte_carlo_vcsgc.py
   :start-after: # step 2

Here we chose :math:`\kappa=200`, which usually provdes a good compromise
